...
- (void)_setIndex:(NSString *)string {
    _index = [string copy];
}
...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary *)attributeDict {
    if ([elementName caseInsensitiveCompare:@"emotion"] == NSOrderedSame) {
        ...
        self.tempString = [NSMutableString string];
    }else if ([elementName caseInsensitiveCompare:@"index"] == NSOrderedSame) {
        self.tempString = [NSMutableString string];
    }
}
...
- (void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName {
    ...
    //index
        ...
        ESpaceEmotionItem* item = [_items lastObject];
        [item _setIndex:self.tempString];
        self.tempString = nil;
    }
...
//        NO == [[ECSAppConfig sharedInstance].currentUser isHWUC]) {
