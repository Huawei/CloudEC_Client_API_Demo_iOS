...
//  ESpaceImage.m
//
//  Created by x00191042 on 7/9/15.
...
+ (id)imageNamed:(NSString *)name
{
    ...
    NSURL *bundleURL = [[ECSSandboxHelper shareInstance].UIResourceBundle bundleURL];
...
@implementation ESpaceImage (IncrementalData)

+ (instancetype)imageWithIncrementalData:(NSData *)data
{
    ESpaceImage *image = [[ESpaceImage alloc] init];
